...
func part1(input []string) (string, error) {
	time, buses := parseInput(input, false)
...
func parseInput(input []string, xsAsZeroes bool) (int, []int) {
...
func init() {
	challenges.RegisterChallengeFunc(2020, 13, 1, "day13.txt", part1)
	challenges.RegisterChallengeFunc(2020, 13, 2, "day13.txt", part2)
}
