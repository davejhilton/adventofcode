...
func getSortedJoltages(input []string) []int {
...
func init() {
	challenges.RegisterChallengeFunc(2020, 10, 1, "day10.txt", part1)
	challenges.RegisterChallengeFunc(2020, 10, 2, "day10.txt", part2)
}
