...
func day17_part1(input []string) (string, error) {
	zSpace := day17_parseInput(input)
...
func day17_part2(input []string) (string, error) {
	wSpace := make([][][][]day17_value, 0, 1)
	wSpace = append(wSpace, day17_parseInput(input))
...
type day17_value bool

func (v day17_value) String() string {
	if v {
		return "#"
	} else {
		return "."
...
func print3DSpace(zSpace [][][]day17_value) {
	for z, ySpace := range zSpace {
		log.Debugf("z=%d\n", z)
...
func print4DSpace(wSpace [][][][]day17_value) {
	for w, zSpace := range wSpace {
		for z, ySpace := range zSpace {
			log.Debugf("z=%d, w=%d\n", z, w)
			for _, xSpace := range ySpace {
