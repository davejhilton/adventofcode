...
func day10_parse(input []string) [][]string {
...
func init() {
	challenges.RegisterChallengeFunc(2021, 10, 1, "day10.txt", day10_part1)
	challenges.RegisterChallengeFunc(2021, 10, 2, "day10.txt", day10_part2)
}
